...
<div class="content-wrapper">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">              
              <!-- AGREGAR NUEVA CARRERA -->
                      ...
                      <button type="button" class="btn btn-sm  ml-auto btn-success" data-bs-toggle="modal" data-bs-target="#idAgregarModa">
                        AGREGAR MODALIDAD <i class="fas fa-plus"></i> 
                      </button>      
            </ol>
          </div>
        </div>
    ...
    <section class="content">
      <div class="container-fluid">
            ...
            <div class="col-12">
              ...
              <div class="card">
                  <div class="card-header">
                    <h2 class="card-title">Lista de Modalidad</h2>
                  </div>
                <div class="card-body">
                  <div class="table-responsive">                         
                    <!--Tabla-->
                    <table id="tableModalidad" class="table table-bordered table-hover table-striped">
        ...
        <!-- /.row -->
         ...
         <!-- Modal -->
         <div class="modal fade" id="idAgregarModa" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h5 class="modal-title" id="staticBackdropLabel">MODALIDAD</h5>  
                                    </div>
 ...
 <script src="./js/modalidad.js"></script>
